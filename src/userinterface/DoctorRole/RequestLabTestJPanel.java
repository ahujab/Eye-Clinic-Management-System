...
public class RequestLabTestJPanel extends javax.swing.JPanel {
     ...
     */
    public RequestLabTestJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, PatientDoctorWorkRequest pat) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(requestTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 140, -1, -1));

        jLabel1.setText("Message");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, -1, -1));
        add(messageJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, 89, -1));
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        ...
        pat.setSender(userAccount);
        pat.setStatus("Sent");
        
        Organization org = null;
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()){
            if (organization instanceof OptometristOrganization){
                org = organization;
                break;
            }
        }
        if (org!=null){
            ...
            //userAccount.getWorkQueue().getWorkRequestList().add(pat);
